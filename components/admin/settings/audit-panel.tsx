...
export function AuditPanel() {
  const { data, isLoading } = useSWR<{ ok: boolean; data: AuditEntry[] }>("/api/v1/admin/audit", fetcher, {
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">ثبت دائمی و تغییرناپذیر تمام عملیات حساس مدیریتی</p>
