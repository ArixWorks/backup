  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div
          className={`max-w-xl space-y-5 rounded-2xl border p-5 transition-colors ${
            form[KEYS.maintenanceEnabled] === "true" ? "border-primary/60 bg-primary/5" : "border-border bg-card"
          }`}
        >
          <Toggle
  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="max-w-xl space-y-5 rounded-2xl border border-border bg-card p-5">
        ...
        <div className="max-w-xl space-y-5 rounded-2xl border border-border bg-card p-5">
          <label className="flex items-center justify-between gap-3 rounded-xl border border-border bg-secondary/40 p-3">
            <div>
              ...
              <div className="text-xs text-muted-foreground">بازگشت درصدی از هر خرید به کیف پول خریدار</div>
            </div>
            <input
              type="checkbox"
          ...
          <label className="flex items-center justify-between gap-3 rounded-xl border border-border bg-secondary/40 p-3">
            <div>
              ...
              <div className="text-xs text-muted-foreground">پاداش دعوت‌کننده و دعوت‌شده پس از اولین خرید</div>
            </div>
            <input
              type="checkbox"
          ...
          <Field label="پاداش کاربر دعوت‌شده (تومان)" hint="مبلغی که به کاربر تازه‌وارد پس از اولین خریدش پرداخت می‌شود">
            <Input
              type="number"
          ...
          <div className="space-y-3 border-t border-border pt-4">
            <div className="space-y-1">
              ...
              <div className="text-xs text-muted-foreground">
                هر سطح با رسیدن به امتیاز مادام‌العمر یا مجموع خرید (هرکدام زودتر) فعال می‌شود. تخفیف سطح با کد
                تخفیف جمع نمی‌شود؛ بیشترین مقدار اعمال می‌شود.
              </div>
            </div>
            ...
            <Field label="تخفیف عضویت ویژه VIP (٪)" hint="تخفیف اعضای VIP که توسط ادمین به‌صورت دستی اعطا می‌شود">
              <Input
                type="number"
