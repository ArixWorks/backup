...
/**
 * LEGACY — the flat "service node" home grid that shipped before the 3D folder
 * design. Kept verbatim (and unused) so the previous look can be restored by
 * pointing `app/page.tsx` at `LegacyHomePage` again. Not imported anywhere.
 */
