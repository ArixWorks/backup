    ...
    >
      ...
      */}
      ...
      {item.image ? (
        ...
        // extension and its price are stacked and centred both axes, so the
        // price reads as the focal point in the middle of the card instead of
        // clinging to a corner.
        <span className={cn("flex h-full w-full flex-col items-center justify-center gap-1 px-1 text-center", a.tint)}>
