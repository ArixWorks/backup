...
export const AI_SETTING_KEYS = {
  ...
  fastModel: "ai.fastModel", // low-latency model for batch/utility jobs (automations, digests)
...
function envDefaults(): Record<string, string> {
  return {
    ...
    [AI_SETTING_KEYS.fastModel]: process.env.AI_FAST_MODEL || "openai/gpt-4.1-mini",
...
export async function getAiConfig(): Promise<AiConfig> {
  ...
  return {
    ...
    fastModel: get(AI_SETTING_KEYS.fastModel),
