...
type Catalog = Record<MessageKey, string>
  ...
  "invite.subtitle": "دوستا��ت را دعوت کن و در سه مرحله پاداش بگیر؛ از عضویت تا هر خرید آن‌ها.",
  ...
  "search.placeholder": "Поис�� товаров…",
  "search.all": "Все",
  ...
  "watchlist.emptyDesc": "С��едите за любимыми аукционами, чтобы получить уведомление о старте.",
  ...
  "invite.s3.desc": "С этого момента вы получаете процент от каждой покупки ваш��го друга в виде кредита.",
  ...
  "nav.menu": "Меню",
  "a11y.supportOnline": "Онлайн-��оддержка",
  ...
  "wallet.depositCreated": "Запрос на пополнение соз��ан",
