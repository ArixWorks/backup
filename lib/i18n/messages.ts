...
const fa: Catalog = {
  ...
  "adetail.reserveMet": "قیمت رزرو فروشنده تأمی�� شده است",
...
const ru: Catalog = {
  ...
  "wins.signInRequired": "Войди��е, чтобы увидеть свои призы.",
  ...
  "refunds.fullNamePlaceholder": "ФИО дер��ателя карты",
  ...
  "catFollow.unfollowed": "В�� отписались от категории «{category}»",
