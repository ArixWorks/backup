...
type Catalog = Record<MessageKey, string>
  ...
  "wallet.signInRequired": "برای مشاهده کیف پول، ابتدا وارد حساب کاربری ��ود شوید.",
  ...
  "verify.invalidLink": "ل��نک تأیید نامعتبر است.",
  ...
  "notif.subtitle": "Последние события вашего аккаунта: пополнения ��оваров, заказы, аукционы и транзакции.",
  ...
  "support.emptyDesc": "Если у вас есть вопрос и��и проблема, создайте новое обращение для команды поддержки.",
  ...
  "bid.minBid": "Минимальная ст��вка — {amount} томан",
