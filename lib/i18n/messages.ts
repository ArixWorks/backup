...
type Catalog = Record<MessageKey, string>
  ...
  "tour.s5.title": "هیچ‌��یز را از دست ندهید",
  ...
  "adetail.noBids": "هنوز پیشنهادی ثبت نشده است. اولین پیشنها�� را شما ثبت کنید.",
  "adetail.auto": "خودکار",
  ...
  const ru: Catalog = {
    ...
    "home.promoBody": "Пополните кошелёк и получите эксклюзивные скидк��",
    ...
    "soon.body": "Мы разрабатыв��ем эт�� функцию, и скоро она появится на платформе.",
    "soon.back": "На панель",
    "vps.title": "VPS-хостинг",
    "vps.subtitle": "Мощный и надёжный облачный хостинг",
    "domains.title": "Регистрация домена",
    "domains.subtitle": "Поиск, цена и регистрация вашего доме��а",
  "nav.home": "Главная",
  ...
  "bid.maxPlaced": "Ваша авто��атическая ставка принята",
  ...
  "coupon.expired": "Срок действия про��окода истёк.",
  ...
  "join.verifying": "Пров��рка подписки…",
  "wallet.signInRequired": "Вой��ите, чтобы увидеть кошелёк.",
  ...
  "wallet.topupError": "Не уда��ось пополнить кошелёк",
  ...
  "refunds.ibanLabel": "IBAN (необяз��т��льно)",
  "refunds.nationalCardLabel": "Фото удостоверения ��ичности",
  ...
  "auth.sendResetLink": "Отпр��вить ссылку для сброса",
  "auth.resetTitle": "Зад��ть новый пароль",
  ...
  "a11y.mainNav": "Основная нав��гация",
  ...
  "gwd.entered": "Вы участ��уете в розыгрыше",
  "gwd.joinChannelsFirst": "Сначала подпиши��есь на требуемые каналы",
