...
type Catalog = Record<MessageKey, string>
  ...
  "invite.s1.desc": "وقت�� دوستت با لینک تو وارد ربات شود و عضویت را کامل کند، پاداش اول را می‌گیری.",
  "invite.s2.title": "اولین خرید دوستت",
  "invite.s2.desc": "با نخستین خرید دوستت، هم تو و هم او ��اداش ویژه‌ی خرید اول را دریافت می‌کنید.",
  ...
  "auth.forgotSentDesc": "اگر حسابی با این ایمیل وجود داشته باشد، لینک بازنشانی ارسال شد. صندوق ورودی خود ر�� بررسی کنید.",
  ...
  "tgLogin.domainNotice": "دامنه‌ی این سایت هنوز در BotFather ثبت نشده است. لطفاً پایین‌تر با ایمیل و��رد شوید.",
  ...
  "ptSrc.GIVEAWAY_ENTRY": "شرکت ��ر قرعه‌کشی",
  ...
  const ru: Catalog = {
    ...
    "svc.store": "Магазин",
    "svc.storeDesc": "Под��иски, аккаунты и цифровые товары",
  ...
  "auth.privacy4": "Telegram проверяет вхо�� на своей стороне до того, как мы что-либо получим",
  "auth.or": "или",
  "auth.email": "Эл. почта",
  ...
  "wins.walletCredited": "{amount} туманов зачислено на ��аш кошелёк.",
  "wins.couponTitle": "Ваш промокод",
  "wins.claimTitle": "Данные для получения приза",
  "wins.position": "Место {n}",
  "wins.empty": "Вы е��ё не выиграли ни одного розыгрыша",
  ...
  "invite.subtitle": "Приглашайте друзей и получайте награды на трёх этапах — от регистрации до ��аждой покупки.",
  ...
  "refunds.notice": "Во избежание злоупотребл���ний сумма возвращается только на карту, с которой ранее было успешное пополнение, а данные (ИНН и фото удостоверения) должны совпадать с держателем карты.",
  ...
  "ticket.closedToast": "Обращен��е закрыто",
  ...
  "acctTg.needOtherMethod": "Чтобы отключить Telegram, сначала задайте ��одтверждённый email и пароль, чтобы иметь другой способ входа.",
  ...
  "referral.shareTitle": "Пригла��ить друзей",
  ...
  "referral.copyAria": "Скопировать ссылку-приглаш��ние",
  ...
  "wallet.network": "Сеть",
  "wallet.transferNote": "Код перевода (укажите в ��римечании)",
  ...
  "convert.error": "Ошибка ко��вертации валюты",
  ...
  "vip.usablePoints": "Доступные баллы",
    "vip.totalSpend": "Всего потра��ено",
