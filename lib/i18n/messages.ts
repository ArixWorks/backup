...
export type MessageKey =
  ...
  | "profile.language"
  | "profile.motion"
  | "profile.statusCenter"
  | "profile.activeAccount"
  | "profile.manageAccount"
  | "profile.securityScore"
  | "profile.securityComplete"
  | "profile.securityRemaining"
  ...
  | "questions.safetyHint"
  | "questions.checking"
  | "questions.submit"
  | "questions.loading"
  | "questions.emptyTitle"
  | "questions.emptyDescription"
  | "questions.listLabel"
  | "questions.smartAnswer"
  | "questions.adminAnswer"
  | "questions.pendingAdmin"
  | "questions.successAnswered"
  | "questions.successPending"
  | "questions.error"
  | "motion.choose"
  | "motion.auto"
  | "motion.cinematic"
...
type Catalog = Record<MessageKey, string>
  ...
  "store.categoryEmpty": "در حال حاضر محصولی برای این بخش موجود نیست.",
    ...
    "store.categoriesTitle": "دسته‌بندی‌های فروشگاه",
    "store.featuredTitle": "انتخاب‌های ویژه",
    "store.featuredBadge": "پیشنهاد ویژه",
    "store.previousSlide": "اسلاید قبلی",
    "store.nextSlide": "اسلاید بعدی",
    "store.inStock": "آماده سفارش",
    "store.outOfStock": "ناموجود",
    "store.viewProduct": "مشاهده محصول",
    "store.filterAll": "همه",
    "store.results": "نتیجه",
    "store.plans": "پلن",
  ...
  "detail.favoriteRemoved": "از علاقه‌مندی‌ها حذف شد",
  ...
  "search.similarTitle": "محصولات مشابه",
  "search.similarHint": "این محصول را نداریم، اما این‌ها ممکن است به کارتان بیایند:",
  "search.noResultsSimilar": "این مورد را نداریم، اما پیشنهادهای مشابهی برایتان داریم:",
  "sort.label": "مرتب‌سازی",
  "sort.newest": "جدیدترین",
  "sort.priceAsc": "ارزان‌ترین",
  "sort.priceDesc": "گران‌ترین",
  "sort.popular": "پرفروش‌ترین",
  "sort.rating": "بیشترین امتیاز",
  ...
  "coupon.userLimit": "شما ��بلاً از این کد استفاده کرده‌اید.",
  ...
  "banned.message": "شما مسدود شدید و امکان دسترسی به خدمات این با�� را ندارید.",
  ...
  "profile.statusCenter": "مرکز وضعیت حساب",
  "profile.activeAccount": "حسا�� فعال",
  "profile.manageAccount": "مدیریت حساب",
  "profile.securityScore": "امنیت حساب",
  "profile.securityComplete": "همه روش‌ها تکمیل است",
  "profile.securityRemaining": "{count} اقدام باقی مانده",
  "profile.spendablePoints": "امتیاز قابل استفاده",
  "profile.untilTier": "تا سطح {tier}",
  "profile.highestTier": "بالاترین سطح عضویت",
  "profile.needsAttention": "نیازمند توجه",
  "profile.unreadNotifications": "اعلان خوانده‌نشده",
  "profile.allClear": "همه‌چیز مرتب است",
  "profile.experienceSettings": "تنظیمات تجربه کاربری",
  "cms.navigationTitle": "راهنما و محتوا",
  "questions.title": "پرسش و پاسخ محصول",
  "questions.subtitle": "سؤال خود را بپرسید؛ پاسخ فقط بر پایه اطلاعات و تصاویر همین محصول ارائه می‌شود.",
  "questions.answersCount": "{count} پاسخ",
  "questions.formLabel": "ثبت پرسش محصول",
  "questions.yourQuestion": "پرسش شما",
  "questions.placeholder": "مثلاً این پلن روی چند دستگاه قابل استفاده است؟",
  "questions.safetyHint": "پاسخ نامطمئن برای مدیر ارسال می‌شود.",
  "questions.checking": "در حال بررسی…",
  "questions.submit": "ثبت پرسش",
  "questions.loading": "در حال دریافت پرسش‌ها",
  "questions.emptyTitle": "هنوز پرسشی ثبت نشده است.",
  "questions.emptyDescription": "اولین نفری باشید که درباره این محصول سؤال می‌پرسد.",
  "questions.listLabel": "پرسش‌های محصول",
  "questions.smartAnswer": "پاسخ هوشمند",
  "questions.adminAnswer": "پاسخ مدیر",
  "questions.pendingAdmin": "در انتظار بررسی مدیر",
  "questions.successAnswered": "پاسخ مستند آماده و منتشر شد.",
  "questions.successPending": "پرسش ثبت شد و برای بررسی مدیر ارسال شد.",
  "questions.error": "ثبت پرسش انجام نشد.",
  ...
  "motion.enableTilt": "فعال‌کردن حرکت کارت",
  "motion.permissionDenied": "برای حرکت کارت، دسترسی حرکت را در تنظیمات آیفون فعال کنید.",
  ...
  "adetail.reserveHidden": "این مزایده دارای قیمت رزرو محرما��ه است",
  ...
  "adetail.soldViaBuyNow": "فروخته‌شده با خرید ف��ری",
  ...
  "wins.walletCredited": "مبلغ {amount} توم��ن به کیف پول شما واریز شد.",
  ...
  "refunds.nationalCardPick": "انتخاب تصویر کار�� ملی",
  ...
  "refunds.errFile": "بارگذاری تصویر کارت ملی الزام�� است",
  ...
  "watch.errUpdate": "خطا در ��ه‌روزرسانی لیست پیگیری",
  "watch.auctionRemoved": "از لی��ت پیگیری حذف شد",
  ...
  "wallet.swipeToChoose": "برای انتخاب روش، بکشید",
  "wallet.payWith": "پرداخت با",
  ...
  "bid.maxTooLow": "سقف پیشنهاد نمی‌��واند کمتر از مبلغ پیشنهاد شما باشد",
  ...
  "missions.pointsReceived": "تبریک! {points} امتیاز با موفقیت به امتیازات شما اضافه شد.",
  "missions.errClaim": "خطا در دریافت پاداش",
  "missions.claim": "دریافت",
  "missions.daily": "مأمور��ت‌های روزانه",
  ...
  "store.categoryEmpty": "There are currently no products in this section.",
    ...
    "store.categoriesTitle": "Shop categories",
    "store.featuredTitle": "Featured picks",
    "store.featuredBadge": "Featured",
    "store.previousSlide": "Previous slide",
    "store.nextSlide": "Next slide",
    "store.inStock": "Ready to order",
  ...
  "detail.favoriteRemoved": "Removed from favorites",
  ...
  "search.similarTitle": "Similar products",
  "search.similarHint": "We don't have that exact item, but these might work for you:",
  "search.noResultsSimilar": "We don't have that, but here are some similar suggestions:",
  "sort.label": "Sort",
  "sort.newest": "Newest",
  ...
  "profile.statusCenter": "Account status center",
  "profile.activeAccount": "Active account",
  "profile.manageAccount": "Manage account",
  "profile.securityScore": "Account security",
  "profile.securityComplete": "All methods are complete",
  "profile.securityRemaining": "Actions remaining: {count}",
  "profile.spendablePoints": "Available points",
  "profile.untilTier": "Until {tier}",
  "profile.highestTier": "Highest membership tier",
  "profile.needsAttention": "Needs attention",
  "profile.unreadNotifications": "Unread notifications",
  "profile.allClear": "Everything is in order",
  "profile.experienceSettings": "Experience settings",
  "cms.navigationTitle": "Guides & content",
  "questions.title": "Product questions & answers",
  "questions.subtitle": "Ask a question; answers are based only on this product’s information and images.",
  "questions.answersCount": "{count} answers",
  "questions.formLabel": "Ask a product question",
  "questions.yourQuestion": "Your question",
  "questions.placeholder": "For example, how many devices can use this plan?",
  "questions.safetyHint": "Uncertain answers are sent to an administrator.",
  "questions.checking": "Checking…",
  "questions.submit": "Submit question",
  "questions.loading": "Loading questions",
  "questions.emptyTitle": "No questions yet.",
  "questions.emptyDescription": "Be the first to ask about this product.",
  "questions.listLabel": "Product questions",
  "questions.smartAnswer": "Smart answer",
  "questions.adminAnswer": "Administrator answer",
  "questions.pendingAdmin": "Awaiting administrator review",
  "questions.successAnswered": "A sourced answer is ready and published.",
  "questions.successPending": "Your question was submitted for administrator review.",
  "questions.error": "Could not submit the question.",
  ...
  "motion.enableTilt": "Enable card motion",
  "motion.permissionDenied": "Enable Motion & Orientation Access in your iPhone settings.",
  ...
  "wallet.swipeToChoose": "Swipe to choose a method",
  "wallet.payWith": "Pay with",
  ...
  const ru: Catalog = {
    ...
    "svc.auctionsDesc": "Выигрывайте товары по выгод��ым ценам",
    "svc.vps": "VPS-хостинг",
    "svc.vpsDesc": "Мощные виртуальные сервер��",
    "svc.domains": "Домены",
  ...
  "tour.s1.body": "Прос��атривайте цифровые товары, аккаунты и ключи. Всё аккуратно разложено.",
  ...
  "tour.s4.body": "Делайте ставки на особые товары и выигрывайте по лучшей цене — уникальн��я возможность.",
  ...
  "home.noFlash": "��ет активных распродаж.",
  ...
  "auctions.reserveNotMetShort": "Резе��в не достигнут",
  ...
  "store.categoryEmpty": "В этом разделе пока нет товаров.",
    ...
    "store.categoriesTitle": "Категории магазина",
    "store.featuredTitle": "Избранные предложения",
    "store.featuredBadge": "Рекомендуем",
    "store.previousSlide": "Предыдущий слайд",
    "store.nextSlide": "Следующий слайд",
    "store.inStock": "Готово к заказу",
    "store.outOfStock": "Нет в наличии",
    "store.viewProduct": "Посмотреть товар",
    "store.filterAll": "Все",
    "store.results": "результатов",
    "store.plans": "тарифов",
  ...
  "detail.favoriteRemoved": "Удалено из избранного",
  ...
  "search.similarTitle": "Похожие товары",
  "search.similarHint": "Такого товара у нас нет, но эти могут вам подойти:",
  "search.noResultsSimilar": "Этого у нас нет, но вот похожие предложения:",
  ...
  "coupon.minOrder": "Сумма заказа с��ишком мала для этого промокода.",
  ...
  "auth.privacyTitle": "Конфиденциальность и безопас��ость",
  ...
  "profile.securityScore": "Безопасность аккаунта",
  "profile.securityComplete": "Все способы настроены",
  "profile.securityRemaining": "Осталось действий: {count}",
  "profile.spendablePoints": "Доступные баллы",
  "profile.untilTier": "До уровня {tier}",
  "profile.highestTier": "Высший уровень участия",
  "profile.needsAttention": "Требует внимания",
  "profile.unreadNotifications": "Непрочитанные уведомления",
  ...
  "questions.yourQuestion": "Ваш вопрос",
  "questions.placeholder": "Например, на скольких устройствах ра��отает этот тариф?",
  "questions.safetyHint": "Неуверенные ответы отправляются администратору.",
  "questions.checking": "Проверка…",
  "questions.submit": "Отправить вопрос",
  "questions.loading": "Загрузка вопросов",
  "questions.emptyTitle": "Вопросов пока нет.",
  "questions.emptyDescription": "Задайте первый вопрос об этом товаре.",
  "questions.listLabel": "Вопросы о товаре",
  "questions.smartAnswer": "Умный ответ",
  "questions.adminAnswer": "Ответ администр��тора",
  "questions.pendingAdmin": "Ожидает проверки администратора",
  "questions.successAnswered": "Подтверждённый ответ готов и опубликован.",
  ...
  "join.notJoined": "Ещё не подписаны — попро��уйте снова",
  ...
  "wallet.topupError": "��е удалось пополнить кошелёк",
  ...
  "payload.url": "Ссылка",
  "delivery.reveal": "Показать",
  "delivery.hide": "Скрыть",
  ...
  "invite.signInRequired": "Войдите, чтобы получить ссылку-приг��ашение.",
  ...
  "refunds.notice": "Во избежание злоупотреблений сумма возвращается только на карту, с которой ранее было успешное пополнение, а данные (ИНН и фото у��остоверения) должны совпадать с держателем карты.",
  ...
  "refunds.nationalCardLabel": "Фото удостоверен��я личности",
  ...
  "ticket.closedNotice": "Это обращение закрыт��.",
  ...
  "newTicket.subjectPlaceholder": "напр. Проблем�� с пополнением кошелька",
  ...
  "signIn.defaultDesc": "Войдите в свой аккаунт, ��тобы продолжить.",
  ...
  "watch.productAdded": "Мы уведомим вас, к��гда товар снова появится",
  ...
  "referral.desc": "Поделитесь персональной ссылкой. Получайте награду за каждое успешное приглашение, а также постоя��ный кредит с",
  ...
  "wallet.swipeToChoose": "Проведите, чтобы выбрать",
  "wallet.payWith": "Оплатить через",
  ...
  "wallet.sendExactly": "Отправ��те точную сумму",
  ...
  "wallet.cryptoWarning": "Отправьте точную сум��у, чтобы перевод можно было сопоставить.",
  ...
  "convert.sameCurrency": "Исходная и ц��левая валюты совпадают",
  ...
  "gwPhase.endedAuto": "Регистрация з��крыта; автоматический розыгрыш скоро",
  "gwPhase.endedManual": "Рег��страция закрыта; ожидается подтверждение администратора",
...
// Roman Hindi (Romanized Hindi) — conversational, Latin script (not Devanagari).
  ...
  "store.categoryEmpty": "Is section mein abhi koi product available nahi hai.",
    ...
    "store.categoriesTitle": "Store categories",
    "store.featuredTitle": "Featured picks",
    "store.featuredBadge": "Featured",
    "store.previousSlide": "Pichhla slide",
    "store.nextSlide": "Agla slide",
    "store.inStock": "Order ke liye taiyar",
    "store.outOfStock": "Stock mein nahi",
    "store.viewProduct": "Product dekhein",
    "store.filterAll": "Sabhi",
    "store.results": "results",
    "store.plans": "plans",
    "store.gridView": "Grid view",
    "store.listView": "List view",
  ...
  "detail.favoriteRemoved": "Pasand se hata diya",
  ...
  "search.similarTitle": "Similar products",
  "search.similarHint": "Hamare paas exact item nahi hai, lekin ye aapke kaam aa sakte hain:",
  "search.noResultsSimilar": "Wo hamare paas nahi hai, lekin ye similar suggestions hain:",
  ...
  "reviews.ratingsCount": "reviews",
  "flash.buy": "Kharidein",
  "flash.buyProduct": "Product kharidein",
  "flash.soldOut": "Sold out",
  "flash.stock": "Stock",
  "flash.sold": "Bike",
  "flash.off": "OFF",
  ...
  "profile.statusCenter": "Account status center",
  "profile.activeAccount": "Active account",
  "profile.manageAccount": "Account manage karein",
  "profile.securityScore": "Account security",
  "profile.securityComplete": "Sabhi methods complete hain",
  "profile.securityRemaining": "{count} actions baaki hain",
  "profile.spendablePoints": "Available points",
  "profile.untilTier": "{tier} level tak",
  "profile.highestTier": "Sabse uncha membership level",
  "profile.needsAttention": "Dhyan dena zaroori",
  "profile.unreadNotifications": "Unread notifications",
  "profile.allClear": "Sab theek hai",
  "profile.experienceSettings": "Experience settings",
  "cms.navigationTitle": "Guides aur content",
  "questions.title": "Product sawaal aur jawaab",
  "questions.subtitle": "Apna sawaal poochhein; jawaab sirf isi product ki jaankari aur images par based hoga.",
  "questions.answersCount": "{count} jawaab",
  "questions.formLabel": "Product sawaal poochhein",
  "questions.yourQuestion": "Aapka sawaal",
  "questions.placeholder": "Jaise, yeh plan kitne devices par use ho sakta hai?",
  "questions.safetyHint": "Uncertain jawaab admin ko bheje jaate hain.",
  "questions.checking": "Check ho raha hai…",
  "questions.submit": "Sawaal submit karein",
  "questions.loading": "Sawaal load ho rahe hain",
  "questions.emptyTitle": "Abhi koi sawaal nahi hai.",
  "questions.emptyDescription": "Is product ke baare mein pehla sawaal poochhein.",
  "questions.listLabel": "Product sawaal",
  "questions.smartAnswer": "Smart jawaab",
  "questions.adminAnswer": "Admin jawaab",
  "questions.pendingAdmin": "Admin review ka intezar",
  "questions.successAnswered": "Verified jawaab taiyar hai aur publish ho gaya.",
  "questions.successPending": "Aapka sawaal admin review ke liye submit ho gaya.",
  "questions.error": "Sawaal submit nahi ho saka.",
  ...
  "motion.enableTilt": "Card motion chalu karein",
  "motion.permissionDenied": "iPhone settings mein Motion & Orientation Access chalu karein.",
  ...
  "payload.note": "Note",
  "payload.url": "Link",
  "delivery.reveal": "Dikhayein",
  "delivery.hide": "Chhupayein",
  ...
  "wallet.swipeToChoose": "Chunne ke liye swipe karein",
  "wallet.payWith": "Pay with",
  "wallet.amountTomanLabel": "Amount (Toman)",
  "wallet.amountUsdLabel": "Amount (USD)",
  "wallet.methodCard": "Card transfer",
