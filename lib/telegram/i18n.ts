...
const BUTTONS: Record<Exclude<Locale, "fa">, Record<string, string>> = {
  en: {
    ...
    profile: "👤 Profile",
    rewards: "🎯 Rewards & missions",
    notifications: "🔔 Notifications",
    support: "🆘 Support",
    bid: "🔨 Place bid",
    buyNowAuction: "🛒 Buy now",
    watch: "👀 Watch",
    unwatch: "🚫 Unwatch",
    iPaid: "✅ I've paid",
  ...
  ru: {
    ...
    replyTicket: "✍️ Ответить",
    closeTicket: "🔒 Закрыть тикет",
    applyCoupon: "🏷️ Промокод",
    prev: "◀️ Назад",
    next: "Далее ▶️",
  ...
  hi: {
    ...
    profile: "👤 प्रोफ़ाइल",
    rewards: "🎯 इनाम और मिशन",
    notifications: "🔔 सूचनाएँ",
    support: "🆘 सहायता",
    bid: "🔨 बोली लगाएँ",
    buyNowAuction: "🛒 अभी खरीदें",
    watch: "👀 फ़ॉलो",
    unwatch: "🚫 अनफ़ॉलो",
    iPaid: "✅ मैंने भुगतान किया",
    uploadReceipt: "🧾 रसीद भेजें",
    claim: "🎁 इनाम लें",
    markAllRead: "✅ सभी पढ़ें",
    newTicket: "➕ नया टिकट",
    replyTicket: "✍️ जवाब",
    closeTicket: "🔒 टिकट बंद करें",
    applyCoupon: "🏷️ कूपन कोड",
    prev: "◀️ पिछला",
    next: "अगला ▶️",
    backToList: "⬅️ सूची पर वापस",
    depCard: "💳 कार्ड",
    depTon: "💎 TON",
    depUsdt: "💵 USDT",
    depStars: "⭐ Telegram Stars",
